/*
  ...
  - The values [CONFIRMADA] on the enum `StatusReservaEnum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "StatusReservaEnum_new" AS ENUM ('PENDENTE', 'CONFIRMADO', 'CANCELADA', 'FINALIZADO');
